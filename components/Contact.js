  ...
  return (
    <div className="h-screen sm:h-screen md:h-screen w-screen md:-mt-60  lg:mt-0 mo flex flex-col justify-center items-center lg:h-screen bg-hero-bg2 bg-right-top  sm:bg-top-left md:bg-top-left lg:bg-top-left xl:bg-top-left bg-cover  bg-no-repeat">
      <div ref={ref}>
        ...
        <p className="flex w-8/12 ml-24 sm:ml-0 md:ml-0 lg:ml-0 xl:ml-0  sm:w-full md:w-full lg:w-full xl:w-full justify-center flex-col text-center font4 text-gray-800 xl:-mt-36 lg:-mt-48 md:-mt-48 lg:text-2xl  xl:text-2xl md:text-xl sm:text-lg ">
          do you have any questions or would like to work together? let's talk!
          <br />
          <span className=" text-green-lightGreen md:text-green-lightGreen lg:text-green-lightGreen xl:text-green-lightGreen sm:text-white xl:text-xl">

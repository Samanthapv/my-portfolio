          ...
          <div className="mr-12 cursor-pointer">
            <Link href={`/midori`}>
              <motion.img
                ...
                src="/midoripic.png"
                alt="midori"
                className={`-ml-32 lg:h-96 lg:w-96 xl:-mt-36 xl:text-xl  z-30 w-auto h-auto xl:mr-64 xl:w-96 xl:h-96 xl:mb-56 sm:mb-30 lg:mr-60 ${
                  inView && "xl:shadow-2xl md:shadow-2xl lg:shadow-2xl"
                }`}
              />
            </Link>
          </div>

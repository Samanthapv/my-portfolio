...
export default function AboutMe() {
    ...
    <div className="h-md lg-h-lg md:h-lg w-screen bg-yellow-extralight text-gray-800 pt-4">
      ...
      >
        <path
          fill="#bfb1d5"
          fill-opacity="1"
          d="M0,32L40,64C80,96,160,160,240,170.7C320,181,400,139,480,106.7C560,75,640,53,720,69.3C800,85,880,139,960,138.7C1040,139,1120,85,1200,58.7C1280,32,1360,32,1400,32L1440,32L1440,0L1400,0C1360,0,1280,0,1200,0C1120,0,1040,0,960,0C880,0,800,0,720,0C640,0,560,0,480,0C400,0,320,0,240,0C160,0,80,0,40,0L0,0Z"
        ></path>
      </svg>
      ...
      <div className="flex flex-col justify-center">
        ...
        <div className="flex flex-col sm:flex-row md:flex-row lg:flex-row xl:flex-row justify-center gap-x-3 mt-6 xl:-mt-10">
          ...
          <div
            className="h-3/4 font4 text-center  sm:text-sm sm:mb-0 md:mb-0 lg:mb-0 xl:mb-0 mb-7 sm:border-l-4 sm:border-dashed sm:border-opacity-90 sm:border-gray-700 sm:pl-2 md:border-l-4 md:border-dashed md:border-opacity-90 md:border-gray-700 md:pl-2 lg:border-l-4 lg:border-dashed
 lg:border-opacity-90 lg:border-gray-700 lg:pl-2 xl:border-l-4 xl:border-dashed xl:border-opacity-90 xl:border-gray-700 xl:pl-2"
          >
            <h1 className="fontmain  text-2xl sm:text-2xl xl:text-3xl lg:text-2xl text-center ">
              {" "}
              education
            </h1>
            <h3>
              <span className="font-black text-sm sm:text-sm xl:text-2xl lg:text-2xl text-purple-lilac">
                *
              </span>{" "}
              <span
                onClick={handleOpenModal}
                className="italic underline xl:text-lg  hover:text-green-lightGreen cursor-pointer sm:text-base"
              >
                codeop
              </span>
            </h3>
            ...
            <p className="text-sm xl:text-base">
              Barcelona, 09/2020 - 11/2020 (550 hours)
            </p>
            ...
            <h3>
              ...
              <span className="italic text-base xl:text-lg md:text-lg sm:text-base">
            ...
            <h3>
              <span className="font-black  sm:text-sm xl:text-2xl lg:text-2xl text-purple-lilac">
                *
              </span>{" "}
              <span className="italic xl:text-lg text-base md:text-lg sm:text-base">
                universidad de málaga, class of 2013
              </span>
            </h3>
            <h5 className="text-sm xl:text-base">
          ...
          <div
            className="xl:h-56 lg:40 xl:pb-20 sm:text-sm sm:border-l-4 sm:border-dashed sm:border-opacity-90 sm:border-gray-700 sm:pl-2 md:border-l-4 md:border-dashed md:border-opacity-90 md:border-gray-700 md:pl-2 lg:border-l-4 lg:border-dashed
 lg:border-opacity-90 lg:border-gray-700 lg:pl-2 xl:border-l-4 xl:border-dashed xl:border-opacity-90 xl:border-gray-700 xl:pl-2"
          >
            <h1 className="fontmain text-2xl sm:text-2xl xl:text-3xl lg:text-2xl text-center mb-2">
              {" "}
            ...
            <ul className="font4 text-sm sm:text-sm xl:text-lg lg:text-base text-center">
              <li>
                ...
                <span className="italic">senior guest specialist</span>{" "}
                (booking.com)
              </li>
